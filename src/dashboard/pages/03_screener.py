...
roe_min = st.sidebar.slider("ROE Min", 0.0, 100.0, 10.0)

de_max = st.sidebar.slider("Debt/Equity Max", 0.0, 5.0, 2.0)

pe_max = st.sidebar.slider("PE Max", 0.0, 100.0, 50.0)
...
st.download_button(
    label="⬇ Download CSV", data=csv, file_name="screener_results.csv", mime="text/csv"
)
